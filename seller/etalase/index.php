...
<body>
	...
	<div class="etalase">
		...
		<div className="p-3 bg-white" style="padding: .75rem;background-color: white;width: 100%;">
			<h1 className="font-semibold mb-3" style="font-weight: 500;margin-bottom: .75rem;">List Produk Toko</h1>
			<a href="../tambahbarang/" style="text-decoration: none;color: #000;">
				<div className="py-3 flex justify-between items-center hover:scale-95 cursor-pointer transition-all" style="padding: .75rem 0;display: flex;justify-content: space-between;align-items: center;cursor: pointer;">
					<div className="flex gap-3" style="display: flex;gap: .75rem;align-items: center;">
			...
			<div className="py-3 flex justify-between items-center hover:scale-95 cursor-pointer transition-all" style="padding: .75rem 0;display: flex;justify-content: space-between;align-items: center;cursor: pointer;">
				...
				<div className="flex items-center gap-3" style="display: flex;align-items: center;gap: .75rem;">
					<span className="text-slate-700 text-xs font-semibold" style="color: rgb(51 65 85);font-size: .75rem;font-weight: 500;">
						2
					</span>
					<svg width="6" height="10" viewBox="0 0 6 10" fill="none" xmlns="http://www.w3.org/2000/svg">
						<path d="M0.764331 10L0 9.27007L4.50956 5L0 0.729927L0.764331 -4.76836e-07L6 5L0.764331 10Z" fill="black" />
			...
			<?php while ($data_produk = mysqli_fetch_array($result_produk)) : ?>
				<div key="1" className="px-3 border-b-2 flex justify-between text-xs pb-1 text-slate-800" style="padding: 0 .75rem;border-bottom: 2px solid #0002;display: flex;justify-content: space-between;align-items: center;font-size: .75rem;padding-bottom: .25rem;color: rgb(30 41 59);">
					<p className="font-semibold" style="font-weight: 500;"><?= $data_produk['name'] ?></p>
