    ...
    <div style="display: flex;justify-content: center;">
        <div style="width: 100vw;max-width: 28rem;height: 100vh;background-color: #618D80;">
            ...
            <div style="position: relative;">
                <!-- 2 ABSOLUTE CIRCLE -->
                <div style="color: white;z-index: 20;background-color: #0005;width: 100%;max-width: 28rem;padding: .5rem 1rem;position: fixed;">
                ...
                <div style="width: 100%;height: 400px;">
                    <Image width="300" height="300" priority alt="produk" src="https://pemweb-uas-frontend.vercel.app/_next/image?url=https%3A%2F%2Fpemweb-api.aldam.my.id%2Fapi%2Fseller%2Ffile%2Fproduct%2F646fa91694c216f6d358c1b3-1686369679608.jpg&w=384&q=75" style="width: 100%;height: 100%;object-fit: cover;" />
                </div>
            </div>
            <!-- DETAIL PRODUK-->
                ...
                <div style="background-color: white;width: 100%;height: 100vh;border-radius: 40px;position: relative;">
                    ...
                    <div style="position: fixed;bottom: 0;max-width: 28rem;width: 100%;">
                        <div>
                            ...
                            <!-- BELI -->
                            <div>
                                <div style="background-color: #fff;display: flex;font-size: 1.5rem;line-height: 2rem;color: white;font-weight: bold;justify-content: space-between;">
                                    ...
                                    <div style="display: flex;">
                                        ...
                                        <div style="padding: .5rem 0;background-color: white;width: 5rem;display: flex;justify-content: center;">
                                            <button onClick="handleSaveCart" style="border: none;background-color: transparent;">
                                                <div style="border: 1px solid #3B82F6;padding: .5rem;width: fit-content;border-radius: 1rem;padding: .75rem .75rem; display: flex;align-items: center;justify-content: center;background-color: #3B82F6;">
                                                    <svg width="21" height="21" viewBox="0 0 15 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M2.05163 6.88587C2.08017 6.53023 2.24162 6.1984 2.50382 5.95645C2.76602 5.7145 3.10973 5.58019 3.4665 5.58026H12.0225C12.3792 5.58019 12.723 5.7145 12.9852 5.95645C13.2474 6.1984 13.4088 6.53023 13.4374 6.88587L14.0071 13.9815C14.0228 14.1768 13.9979 14.3732 13.9339 14.5584C13.87 14.7435 13.7684 14.9135 13.6355 15.0574C13.5027 15.2014 13.3415 15.3163 13.1621 15.3949C12.9826 15.4735 12.7889 15.5142 12.593 15.5142H2.89601C2.70012 15.5142 2.50635 15.4735 2.32692 15.3949C2.14749 15.3163 1.98628 15.2014 1.85344 15.0574C1.7206 14.9135 1.619 14.7435 1.55505 14.5584C1.4911 14.3732 1.46617 14.1768 1.48184 13.9815L2.05163 6.88587V6.88587Z" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                                        <path d="M10.5828 7.70896V4.16112C10.5828 3.40836 10.2838 2.68644 9.75148 2.15416C9.2192 1.62188 8.49728 1.32285 7.74452 1.32285C6.99177 1.32285 6.26984 1.62188 5.73756 2.15416C5.20528 2.68644 4.90625 3.40836 4.90625 4.16112V7.70896" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                                    </svg>
                                                </div>
                                            </button>
                                        </div>
