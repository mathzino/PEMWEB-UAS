              ...
              <div style="background: #ffffff; box-shadow: 0px 0px 16px rgba(0, 0, 0, 0.1); border-radius: 8px; padding: 16px; display: flex; gap: 20px">
                ...
                <div>
                  ...
                  <div style="display: flex; gap: 8px">
                    <div style="padding: 6px 8px; border-radius: 8px; font-family: 'Inter'; font-style: normal; font-weight: 700; font-size: 12px; line-height: 15px; color: #000000; background-color: #ffd600">Detail</div>
                    <div style="padding: 6px 8px; border-radius: 8px; font-family: 'Inter'; font-style: normal; font-weight: 700; font-size: 12px; line-height: 15px; color: #000000; background-color: #fb7777">Chekout</div>
                  </div>
                </div>
              </div>
            </div>
