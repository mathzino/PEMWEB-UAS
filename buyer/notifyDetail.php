          ...
          <div style="width: 100%; height: 100vh; background-color: #ffffff; border-radius: 3rem">
            <div style="padding-left: 2rem; padding-right: 2rem; padding-top: 2.25rem; padding-bottom: 0.25rem; display: flex; flex-direction: column; gap: 1rem">
              <div style="display: flex; gap: 8px">
                ...
                <p style="font-family: 'Inter'; font-style: normal; font-weight: 500; font-size: 24px; line-height: 29px; color: #4a4a4a; margin-bottom: 1rem">Detail belanjaan anda</p>
              </div>
            </div>
            <!--  -->
            <!--  -->
            ...
            <div style="padding: 24px 36px">
              <div style="padding: 16px; background: #ffffff; box-shadow: 0px 0px 16px rgba(0, 0, 0, 0.1); border-radius: 8px">
                ...
                <div style="font-family: 'Inter'; font-style: normal; font-weight: 400; font-size: 16px; line-height: 19px; color: #3b82f6; text-align: center; margin-top: 20px">Kode konfirmasi</div>

                <div style="font-family: 'Inter'; font-style: normal; font-weight: 700; font-size: 40px; line-height: 48px; color: #3b82f6; text-align: center; margin-top: 4px">M32DF</div>

                <div style="font-family: 'Inter'; font-style: normal; font-weight: 400; font-size: 16px; line-height: 19px; color: #3b82f6; margin-top: 24px">Detail belanjaan :</div>
                  ...
                  <div style="background: #ffffff; box-shadow: 0px 0px 16px rgba(0, 0, 0, 0.1); border-radius: 8px; display: flex; gap: 20px; overflow: hidden">
                    ...
                    <div style="display: flex; flex-direction: column; justify-content: center">
                      <div style="display: flex; gap: 4px; align-items: center">
                        ...
                        <div style="font-family: 'Inter'; font-style: italic; font-weight: 400; font-size: 8px; line-height: 10px; color: #3b82f6">Nama toko</div>
                      </div>
