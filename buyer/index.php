...
$queryGetProducts = "SELECT product.product_id,product.name,product.price,product.product_uom,product.product_category as category,product.image, star.star, toko.name AS storeName,product_uom.uom FROM product
INNER JOIN star ON product.product_id = star.id_product
INNER JOIN toko ON toko.toko_id=product.toko_id
INNER JOIN product_uom on product_uom.id_product_uom=product.product_uom " . $filter ;
...
?>
            ...
            <div style="margin-top: 0.5rem">
              <div style="display: flex; justify-content: space-between">
                ...
                <div style="display: flex; gap: 0.5rem">
                  ...
                  <a href="./cart.php">
                    <div style="border: 1px solid #3b82f6; padding: 0.5rem; width: fit-content; border-radius: 100%; display: flex; align-items: center; justify-content: center; position: relative">
                    <?php 
        ...
        <div style="padding: 0 1.25rem">
          <div style="display: flex; align-items: center">
            <div style="font-size: 0.75rem; line-height: 1rem; margin-right: 0.5rem; display: flex; font-weight: 400; color: #3b82f6">Kategori :</div>
        ...
        <div style="margin-top: 1rem">
          <div style="width: 100%; background-color: white; border-top-left-radius: 1.5rem; border-top-right-radius: 1.5rem; min-height: 100vh; padding:0 40px;">
             ...
             <?php while ($product = mysqli_fetch_array($products)) : ?>
                ...
                >
                  ...
                  <div style="padding: 0.25rem 0.75rem; flex-direction: column; height: 7rem">
                    <div>
                      <p style="font-size: 10px; color: #3b82f6"><?php echo $product["name"]?></p>
                      <p style="font-size: 0.75rem; line-height: 1rem; font-weight: bold; color: #3b82f6; margin-top: 0.5rem">Rp <?php echo $product['price']. "/" . $product['uom']?></p>
                    ...
                    <div style="display: flex; align-items: center; position: absolute; bottom: 0.75rem">
                      ...
                      <p style="color: #3b82f6; font-size: 8px; transform: scale(0.8)"><?php echo $product['storeName']?></p>
                    </div>
                  </div>
                </div>
              </a>
