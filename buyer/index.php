...
<body>
  <div style="display: flex; justify-content: center">
    <div
      ...
      <?php
      if (isset($_POST)&&(isset($_POST['buy'])||isset($_POST['buyfromcart']))) {
        if(isset($_POST['buy'])){

          $checkout = new stdClass();
          $checkout->toko_id = $_POST['toko_id'];
          
          
          $checkoutProduct = new stdClass();
          $checkoutProduct->id_product = $_POST['id_product'];
          $checkoutProduct->qt = $_POST['qt'];
          $checkoutProduct->price = $_POST['price'];
          
          $checkout->products = array($checkoutProduct);
          $_SESSION['transactionTemp'] = $checkout;
