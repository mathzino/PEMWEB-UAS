        ...
        <div className="mt-4" style="margin-top: 1rem">
          <div style="width: 100%; height: 100vh; background-color: #ffffff; border-radius: 3rem">
            <div style="padding-left: 2rem; padding-right: 2rem; padding-top: 2.25rem; padding-bottom: 0.25rem; display: flex; flex-direction: column; gap: 1rem">
              <p style="font-family: 'Inter'; font-style: normal; font-weight: 500; font-size: 24px; line-height: 29px; color: #4a4a4a; margin-bottom: 1rem">Keranjang belanjaan anda</p>
            </div>
            <!--  -->
            <!--  -->

            <!--  -->
            <!-- CARD STATUS PEMBELIAN -->
            <!-- sukses -->
            <div style="padding: 24px 36px">
              <div style="background: #ffffff; box-shadow: 0px 0px 16px rgba(0, 0, 0, 0.1); border-radius: 8px; padding: 16px; display: flex; gap: 20px">
                <div style="width: 88px; height: 88px; border-radius: 100%; background-color: #cbcbcb; position: relative; overflow: hidden">
                  <img style="object-fit: cover; width: 100%; height: 100%" src="https://i0.wp.com/www.piknikdong.com/wp-content/uploads/2023/05/PP-WA-Sad-Boy-HD-Anime-5-e1683087559362.jpg" alt="" />
                </div>
                <div>
                  <div style="display: flex; gap: 4px; align-items: center">
                    ...
                    <div style="font-family: 'Inter'; font-style: normal; font-weight: 400; font-size: 16px; line-height: 19px; color: #618d80">Nama toko</div>
                  </div>
                  <div style="font-family: 'Inter'; font-style: normal; font-weight: 700; font-size: 16px; line-height: 19px; color: #618d80; margin-top: 12px; margin-bottom: 7px">Rp 10.000</div>
                  <div style="display: flex; gap: 8px">
                    <div style="padding: 6px 8px; border-radius: 8px; font-family: 'Inter'; font-style: normal; font-weight: 700; font-size: 12px; line-height: 15px; color: #000000; background-color: #3b82f6">Diterima Penjual</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div style="padding: 24px 36px">
              <div style="background: #ffffff; box-shadow: 0px 0px 16px rgba(0, 0, 0, 0.1); border-radius: 8px; padding: 16px; display: flex; gap: 20px">
                <div style="width: 88px; height: 88px; border-radius: 100%; background-color: #cbcbcb; position: relative; overflow: hidden">
                  <img style="object-fit: cover" width="100%" src="https://i0.wp.com/www.piknikdong.com/wp-content/uploads/2023/05/PP-WA-Sad-Boy-HD-Anime-5-e1683087559362.jpg" alt="" />
                </div>
                <div>
                  <div style="display: flex; gap: 4px; align-items: center">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div style="font-family: 'Inter'; font-style: normal; font-weight: 700; font-size: 16px; line-height: 19px; color: #618d80; margin-top: 12px; margin-bottom: 7px">Rp 10.000</div>
                  <div style="display: flex; gap: 8px">
                    <div style="padding: 6px 8px; border-radius: 8px; font-family: 'Inter'; font-style: normal; font-weight: 700; font-size: 12px; line-height: 15px; color: #000000; background-color: #fb7777">Ditolak Penjual</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div style="padding: 24px 36px">
              <div style="background: #ffffff; box-shadow: 0px 0px 16px rgba(0, 0, 0, 0.1); border-radius: 8px; padding: 16px; display: flex; gap: 20px">
                ...
                <div>
                  ...
                  <div style="font-family: 'Inter'; font-style: normal; font-weight: 700; font-size: 16px; line-height: 19px; color: #618d80; margin-top: 12px; margin-bottom: 7px">Rp 10.000</div>
                  <div style="display: flex; gap: 8px">
                    <div style="padding: 6px 8px; border-radius: 8px; font-family: 'Inter'; font-style: normal; font-weight: 700; font-size: 12px; line-height: 15px; color: #000000; background-color: #ffd600">Menunggu Konfirmasi</div>
                  </div>
                </div>
              </div>
            </div>
