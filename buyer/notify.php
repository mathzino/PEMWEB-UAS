      ...
      <div className="mt-4" style="margin-top: 1rem">
        <div style="width: 100%; min-height: 100vh; background-color: #ffffff; border-radius: 3rem">
          ...
          <?php if($status == 'rating'):?>
            <center><p style="color:green">Rating Berhasil Diberikan</p></center>
          <?php endif;?>
          ...
          if (isset($_SESSION['notif'])) {
            foreach ($_SESSION['notif'] as $id_transaction) {
              ...
              if ($cardInformation['status'] == 0 || $cardInformation['status'] == 1 || $cardInformation['status'] == 2) {
                ?>
                  ...
                  <div
                    ...
                    <div
                      ...
                      <img style="object-fit: cover; width: 100%; height: 100%"
                        src="../seller/assets/toko/<?php echo $cardInformation['image_profile'] ?>"
                    ...
                    <div>
                      ...
                      <?php  if ($cardInformation['status'] == 0):?>
                        <div
                        ...
                        <?php endif; if ($cardInformation['status'] == 1):?>
                          <div
                            style="padding: 6px 8px; border-radius: 8px; font-family: 'Inter'; font-style: normal; font-weight: 700; font-size: 12px; line-height: 15px; color: #3b82f6; background-color: white;border:1px solid #3b82f6;">
                            Pesanan Dikonfirmasi
                          </div>
                        <?php endif; if($cardInformation['status'] == 2):?>
                          <div
                            style="padding: 6px 8px; border-radius: 8px; font-family: 'Inter'; font-style: normal; font-weight: 700; font-size: 12px; line-height: 15px; color: white; background-color: #618D80;">
                            Transaksi Seleseai
                          </div>
                        <?php endif;?>
